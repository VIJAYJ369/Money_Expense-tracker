    ...
    <div className="dashboard page-fade-in">
      <div className="dashboard-header">
        <div>
          ...
          <p className="dashboard-sub">{monthLabel} overview</p>
        </div>
      </div>
      ...
      <div className="stat-grid">
        <StatCard
          ...
          sub={`${stats.incomeCount} transactions`}
          gradient="linear-gradient(135deg,rgba(0,229,160,0.15),rgba(6,182,212,0.08))"
          icon="📈"
        />
        <StatCard
          ...
          gradient="linear-gradient(135deg,rgba(255,77,109,0.15),rgba(249,115,22,0.08))"
          icon="📉"
        />
        <StatCard
          label="Net Balance"
        ...
        <StatCard
          ...
          value={
            stats.income > 0
              ? `${Math.max(0, (stats.balance / stats.income) * 100).toFixed(1)}%`
              : "—"
          }
          sub="of income saved"
      ...
      <div className="chart-row">
        <div className="card chart-card chart-wide">
          <h3 className="chart-title font-display">
            ...
            <div className="recent-list">
              {recentTx.map((tx) => (
                <div key={tx._id} className="recent-item">
                  ...
                  <span
                    className={`recent-amount ${tx.type === "income" ? "text-income" : "text-expense"}`}
                  >
                    {tx.type === "income" ? "+" : "-"}
                    {fmt(tx.amount)}
                  </span>
